...
import { PriorityQueue } from './core/services/priorityQueue'
import { QueueEntry } from './core/services/queueEntry'
...
// const triage1: Triage = new Triage(1, patient1, redRisk)
