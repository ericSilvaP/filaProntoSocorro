...
import { createUser, deleteUserByEmail, getAllUsers, getUserByEmail } from "@/database/userRepository";
...
//     switch (papel) {
//       case "medico":
//         deletedEmployeeCount = deleteMedicoById(referencia_id);
//         break;
//       case "enfermeira":
...
//       return NextResponse.json({ error: "Funcionário não encontrado para deleção" }, { status: 404 });
//     }
