...
export function Header() {
  ...
  return (
    <div id="header absolute">
      ...
      <header className="flex justify-between px-5 py-1.5 bg-[rgb(56,163,165)] shadow-xl">
        <Image
          src="/systemLogo.svg"
          alt=""
          width={35}
        ...
        <div className="flex gap-2 items-center relative">
          <Link href={'/filaExibicao'}>
            <div className="h-[45px] w-[45px] -translate-y-1 cursor-pointer hover:bg-[rgba(0,0,0,0.2)] transition ease-in-out duration-300 rounded-full flex items-center justify-center">
              <Image src="/home.svg" alt="" width={25} height={25} className="text-white" />
            </div>
          </Link> 
          <div className="h-[45px] w-[45px] -translate-y-1 cursor-pointer hover:bg-[rgba(0,0,0,0.2)] transition ease-in-out duration-300 rounded-full flex items-center justify-center p-2" onClick={toggleMenu}>
            <Image src={'/menu_24_white.svg'} alt="" width={35} height={35} />
          </div>
        </div>
      </header>
    </div>
